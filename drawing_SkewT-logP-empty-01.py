...
for selected_time in selected_times[0:1] :
    ...
    try :     
        ...
        #0.0001, 0.0005, 0.001, 0.015, 0.002, 0.003, 0.005, 0.007, 0.010, 0.015, 0.020, 0.030, 0.040, 0.050        
        #plt.text(-50, 1150, 'mixing ratio', horizontalalignment='left', verticalalignment='center', fontsize=9, color='blue')
        #plt.text(-39, 1150, '{0}'.format(mixing_ratio_ticks[0][0]), horizontalalignment='left', verticalalignment='center', fontsize=9, color='blue')
        #plt.text(-22, 1150, '{0}'.format(mixing_ratio_ticks[1][0]), horizontalalignment='left', verticalalignment='center', fontsize=9, color='blue')
        #plt.text(-14, 1150, '{0}'.format(mixing_ratio_ticks[2][0]), horizontalalignment='left', verticalalignment='center', fontsize=9, color='blue')
        #plt.text(-7, 1150, '{0}'.format(mixing_ratio_ticks[3][0]), horizontalalignment='left', verticalalignment='center', fontsize=9, color='blue')
        #plt.text(-1.7, 1150, '{0}'.format(mixing_ratio_ticks[4][0]), horizontalalignment='left', verticalalignment='center', fontsize=9, color='blue')
        #plt.text(5, 1150, '{0}'.format(mixing_ratio_ticks[5][0]), horizontalalignment='left', verticalalignment='center', fontsize=9, color='blue')
        #plt.text(10, 1150, '{0}'.format(mixing_ratio_ticks[6][0]), horizontalalignment='left', verticalalignment='center', fontsize=9, color='blue')
        #plt.text(15.5, 1150, '{0}'.format(mixing_ratio_ticks[7][0]), horizontalalignment='left', verticalalignment='center', fontsize=9, color='blue')
        #plt.text(22, 1150, '{0}'.format(mixing_ratio_ticks[8][0]), horizontalalignment='left', verticalalignment='center', fontsize=9, color='blue')
        #plt.text(27, 1150, '{0}'.format(mixing_ratio_ticks[9][0]), horizontalalignment='left', verticalalignment='center', fontsize=9, color='blue')
        #plt.text(33, 1150, '{0}'.format(mixing_ratio_ticks[10][0]), horizontalalignment='left', verticalalignment='center', fontsize=9, color='blue')
        #plt.text(38, 1150, '{0}'.format(mixing_ratio_ticks[11][0]), horizontalalignment='left', verticalalignment='center', fontsize=9, color='blue')
        #plt.text(42, 1150, '{0}'.format(mixing_ratio_ticks[12][0]), horizontalalignment='left', verticalalignment='center', fontsize=9, color='blue')
        ...
        plt.savefig('skewT_logP_empty.png'.format(dir_name, save_dir_name, filename_el[-5], selected_time[:13]),
            dpi=None, facecolor='w', edgecolor='w',
            orientation='portrait', papertype=None, format=None,
            transparent=False, bbox_inches=None, pad_inches=0.1,
            frameon=None, metadata=None)
        plt.savefig('skewT_logP_empty.pdf'.format(dir_name, save_dir_name, filename_el[-5], selected_time[:13]),
            dpi=None, facecolor='w', edgecolor='w',
            orientation='portrait', papertype=None, format=None,
            transparent=False, bbox_inches=None, pad_inches=0.1,
            frameon=None, metadata=None)
