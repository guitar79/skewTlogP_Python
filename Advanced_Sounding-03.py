...
dir_name = '47122/'
file_name = 'UPPER_SONDE_47122_ALL_2011_2011_2015-2.csv'
#file_name = 'UPPER_SONDE_47122_ALL_2016_2016_2018.csv'
...
s_start_date = datetime(int(file_name_el[4]), 1, 1) #convert startdate to date type
s_end_date = datetime(int(file_name_el[4]), 12, 31)
...
for selected_time in selected_times :
    ...
    try : 
        ...
        df_selected_time.to_csv(r'{0}skew_T-log_P-diagram/{1}.csv'.format(dir_name, selected_time[:13]))
        ###########################################
        ...
        plt.text(10, 1400, 'LCL pressure : {0:.0f}'.format(lcl_pressure), horizontalalignment='left', verticalalignment='center', fontsize=12)
        plt.text(13.3, 1500, 'LCL temerature : {0:.0f}'.format(lcl_temperature), horizontalalignment='left', verticalalignment='center', fontsize=12)
        ...
        skew.plot_mixing_lines(color='blue', linestyle='--', linewidth=0.8)
        
        
        # Show the plot
        plt.show()
        fig.savefig('{0}skew_T-log_P-diagram/{1}_solution.png'.format(dir_name, selected_time[:13]), dpi=None, facecolor='w', edgecolor='w',
        ...
        write_log(err_log_file, '{4} ::: {0} with {1}{2} on {3}'.format(err, dir_name, file_name, selected_time[:13], datetime.now()))