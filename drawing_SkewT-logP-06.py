...
for dir_name in dir_names[1:2]:
    ...
    for fullname in sorted(glob(os.path.join(dir_name, '*.csv')))[3:4]:
        ...
        for selected_time in selected_times[100:102]:
            ...
            plt.savefig('{0}{1}{2}_{3}_under_400hPa_solution.png'.format(dir_name, save_dir_name, filename_el[-5], selected_time[:13]),
                dpi=None, facecolor='w', edgecolor='w',
                orientation='portrait', papertype=None, format=None,
                transparent=False, bbox_inches=None, pad_inches=0.1,
                frameon=None, metadata=None)
            plt.savefig('{0}{1}{2}_{3}_under_400hPa_solution.pdf'.format(dir_name, save_dir_name, filename_el[-5], selected_time[:13]),
                dpi=None, facecolor='w', edgecolor='w',
                orientation='portrait', papertype=None, format=None,
                transparent=False, bbox_inches=None, pad_inches=0.1,
                frameon=None, metadata=None)
