...
dir_names = ['../rawin_data/47102/', '../rawin_data/47104/', '../rawin_data/47155/', '../rawin_data/47158/', '../rawin_data/47185/', '../rawin_data/47186/', '../rawin_data/47090/']
    ...
    for fullname in sorted(glob(os.path.join(dir_name, '*.csv'))):
        ...
        for selected_time in selected_times:
            ...
            try : 
                ...
                plt.savefig('{0}{1}{2}_{3}_student.png'.format(dir_name, save_dir_name, filename_el[-5], selected_time[:13]),
                    dpi=None, facecolor='w', edgecolor='w',
                    orientation='portrait', papertype=None, format=None,
                    transparent=False, bbox_inches=None, pad_inches=0.1,
                    frameon=None, metadata=None)
                plt.savefig('{0}{1}{2}_{3}_student.pdf'.format(dir_name, save_dir_name, filename_el[-5], selected_time[:13]),
                    dpi=None, facecolor='w', edgecolor='w',
                    orientation='portrait', papertype=None, format=None,
                    transparent=False, bbox_inches=None, pad_inches=0.1,
                    frameon=None, metadata=None)
