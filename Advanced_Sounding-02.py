...
s_start_date = datetime(2018, 1, 1) #convert startdate to date type
...
for selected_time in selected_times :
    ...
    try : 
        ...
        df_selected_time.to_csv(r'{0}Osan_data_{1}.csv'.format(dir_name, selected_time[:13]))
        ###########################################
        ...
        # Show the plot
        plt.show()
        fig.savefig('{0}Osan_data_{1}_solution.png'.format(dir_name, selected_time[:13]), dpi=None, facecolor='w', edgecolor='w',
