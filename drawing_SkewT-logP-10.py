...
for dir_name in dir_names:
    ...
    for fullname in sorted(glob(os.path.join(dir_name, '*.csv'))):
        ...
        save_dir_name = 'skew_T-log_P-diagram2_{0}/'.format(obs_year)
        ...
        for selected_time in selected_times:
            ...
            and not os.path.isfile('{0}{1}{2}_{3}_student.csv'.format(dir_name, save_dir_name, filename_el[-5], selected_time[:13])) :
                ...
                try : 
                    ...
                    plt.text(-30, 1360, '$ \cdotp $ LCF (   ): {0:.1f}, {1:.1f}'.format(LCF_pressure, LCF_temperature), horizontalalignment='left', verticalalignment='center', fontsize=12)
                    plt.text(-30, 1410, '$ \cdotp $ EL   (   ): {0:.1f}, {1:.1f}'.format(EL_pressure, EL_temperature), horizontalalignment='left', verticalalignment='center', fontsize=12)
                    plt.text(-27, 1310, 'o', horizontalalignment='left', verticalalignment='center', fontsize=12, color='black')
                    plt.text(-27, 1360, 'x', horizontalalignment='left', verticalalignment='center', fontsize=12, color='red')
                    plt.text(-27, 1410, 'o', horizontalalignment='left', verticalalignment='center', fontsize=12, color='blue')
                    ...
                    plt.text(10.70, 1410, '$ \cdotp $ {0}'.format(filename), horizontalalignment='left', verticalalignment='center', fontsize=12)
